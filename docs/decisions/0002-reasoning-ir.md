# 0002 — Canonical internal model: Reasoning IR
    ...
    * Date: 2025-12-26
    ...
    ## Decision Outcome
    Adopt **Reasoning IR** (Intermediate Representation) as the internal canonical model. All compilation passes operate on Reasoning IR; rendering/export is derived from it.
