...
namespace ContextCompiler.Modules.BuiltIn.Templates;

public sealed class FramingTemplateModule : ITemplateModule
{
    public ModuleMetadata Metadata => BuiltInMetadata.Meta("builtin.template.framing", GlobalPipelineModuleKinds.Template, priority: 0);
