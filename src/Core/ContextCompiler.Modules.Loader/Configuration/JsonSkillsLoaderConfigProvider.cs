...
public sealed class JsonSkillsLoaderConfigProvider(ILogger<JsonSkillsLoaderConfigProvider> logger) : ISkillsLoadConfigProvider
{
    private readonly ILogger<JsonSkillsLoaderConfigProvider> _logger = logger;
    ...
    public ISkillsLoadConfig Current => _cached?.Skills ?? throw new InvalidOperationException("Config not loaded");

    public ISkillsLoadConfig GetConfigOrDefault(string? configPath)
    {
