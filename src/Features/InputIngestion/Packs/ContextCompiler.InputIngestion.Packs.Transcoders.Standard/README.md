...
`ContextCompiler.InputIngestion.Packs.Transcoders.Standard` bundles the default transcoder modules for ContextCompiler.

Included modules:

- `ContextCompiler.InputIngestion.Modules.Transcoders.Linear` - Handles linear data shapes (text, files)
- `ContextCompiler.InputIngestion.Modules.Transcoders.Tabular` - Handles tabular data shapes (tables, structured data)
