...
`ContextCompiler.Prompting.Blueprints.Agile.UserStory` bundles the standard ContextCompiler packs and modules needed to write high-quality Agile User Stories.

## Includes

- `ContextCompiler.Packs.Starter.Standard`
- `ContextCompiler.Prompting.Modules.Personas.Analysts.Business`
