# ContextCompiler.Prompting.Blueprints.Testing.TestCase
...
This blueprint integrates with the **Test Analyst persona module** (`ContextCompiler.Prompting.Modules.Personas.Testers.Analyst`) which provides:
