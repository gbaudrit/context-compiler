...
using ContextCompiler.Plugins.Readers.Excel.Configurations;

namespace ContextCompiler.Plugins.Readers.Excel;
...
{
    public PluginMetadata Metadata => IPlugin.Meta("readers.excel", GlobalPipelinePluginKinds.FileReader, priority: 10);
