...
The **ContextCompiler.Blueprints.DotNet.Api.Backend** blueprint provides comprehensive, step-by-step guidance for building professional, production-ready REST API backends using .NET Core. It covers architecture, security, validation, documentation, testing, and deployment.
...
### NuGet Package
```bash
dotnet add package ContextCompiler.Blueprints.DotNet.Api.Backend
```
  ...
  "modules": [
    {
      ...
      "package": "ContextCompiler.Blueprints.DotNet.Api.Backend",
      "version": "1.0.0"
    }
  ]
}
...
- **ContextCompiler.Blueprints.DotNet.WebApp.Razor** - For Razor Pages frontend
- **ContextCompiler.Blueprints.Agile.UserStory** - For requirements documentation
