...
{
    internal sealed class GeneralPromptComposer(IPrompt prompt, IOutput output, ICtxcConfigProvider ctxcConfig, IModulesRegistry modules, IReasoningIr ir) : IPromptComposerModule
    {
