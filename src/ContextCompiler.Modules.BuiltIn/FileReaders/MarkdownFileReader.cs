...
namespace ContextCompiler.Modules.BuiltIn.FileReaders;

public sealed class MarkdownFileReaderModule(IFileReadResultBuilder fileReadResultBuilder, IFileContentBuilder fileContentBuilder, ILinearFileReader linearFileReader) : IFileReaderModule
{
    public ModuleMetadata Metadata => BuiltInMetadata.Meta("builtin.markdown.reader", GlobalPipelineModuleKinds.FileReader, priority: 9);
