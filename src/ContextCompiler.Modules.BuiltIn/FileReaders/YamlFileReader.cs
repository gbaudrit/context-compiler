...
public sealed class YamlFileReaderModule(IFileReadResultBuilder fileReadResultBuilder, IFileContentBuilder fileContentBuilder, ILinearFileReader linearFileReader) : IFileReaderModule
{
    public ModuleMetadata Metadata => BuiltInMetadata.Meta("builtin.yaml.reader", GlobalPipelineModuleKinds.FileReader, priority: 9);
